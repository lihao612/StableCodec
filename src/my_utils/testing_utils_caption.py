...
def parse_args_testing(input_args=None):
    ...
    parser.add_argument("--caption_json", type=str, default='data/div2k_caption.json', help="Path to image-caption json file")
    ...
    # tile text weight network
    parser.add_argument("--use_tile_text_weight_net", action="store_true")
    parser.add_argument("--tile_text_hidden_dim", default=256, type=int)
    parser.add_argument("--tile_text_gamma", default=0.5, type=float)
