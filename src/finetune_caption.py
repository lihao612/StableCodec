...
def main(args):
    ...
    train_dataset = H5CaptionDataset(
        args.train_dataset,
        ...
        transform=transforms.Compose([
            ...
            #改成中心裁剪
            transforms.Resize(args.train_patch_size),
            transforms.CenterCrop((args.train_patch_size, args.train_patch_size)),
    ...
    test_dataset = CaptionImageDataset(
        args.test_dataset,
        caption_json=args.test_caption_json,
        transform=transforms.Compose([
            transforms.ToTensor(),
            transforms.Normalize([0.5, 0.5, 0.5], [0.5, 0.5, 0.5]),
        ])
                ...
                if accelerator.is_main_process:
                    ...
                    if global_step % args.eval_freq == 1:
                        ...
                        for id, batch_val in enumerate(test_dataloader):
                            ...
                            with torch.no_grad():
                                x_hat, RateLossOutput = accelerator.unwrap_model(net)(batch_val, val_prompts, H, W)
